...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active btnsss" href="../home.php">Back to User</a>
        </li>
      </ul>
    </div>
  </div>
...
<main>
    ...
    <div class="text-center">
        ...
        <li class="mx-2 btnss p-2"><button class="btn btn"><a href="user_senior.php" class="text-black" style="text-decoration: none;">Show Seniors</a></button></li>
        <li class="mx-2 btnss p-2 btn"><a href="user_details.php" class="text-black" style="text-decoration: none;">Show All</a></li>
        </ul>
    </div>
