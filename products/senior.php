...
if(mysqli_num_rows($result) > 0){
    ...
    <div class='card mb-5 shadow' style='width: 23rem; margin:0 auto; border:none; height: 50rem'>
        ...
        <a href='update.php?id={$animal['id']}' class='btn btn-secondary btnss mb-3'>Update Animal</a>
        <a href='delete.php?id={$animal['id']}' class='btn btn-secondary btnss mb-3'>Delete Animal</a>
...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <a class="navbar-brand ms-5 px-2 btnsss" href="index.php">Available Pets</a>
